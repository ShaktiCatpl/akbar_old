...
function proceedfloat(){
    ...
    $.ajax({ 
			...
			if(msgres[0]=='Error') {
				...
				//window.location = 'thank.php?status='+status+'&proposalNum='+proposalNum+'&clientNo='+clientNo;
			}
			}
	});
}
...
<body>
    ...
    <!--<div class="page_nav">
    Quotation » Secure</div>-->
    <?php include 'inc/editSecure.php'; ?>
    <div class="mid_inner_container_otc" id="proposal_form" >
    	<div class="quoteBoxgreen">Get a Quick Quote > Secure <a href="javascript://"  id="editquote">Edit Quote</a></div>
                            ...
                            <tr>
                                <td height="40" valign="middle"><table width="949" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="127" valign="top"><input type="text" name="ValidPinCode" id="ValidPinCode" onBlur="getCityName();" class="txtfield_OTC" style="width:90px;" placeholder="Pincode" value="<?php echo $PIN_CODE; ?>" />&nbsp;<span class="mandatorytxt">*</span></td>
                            ...
                            <tr>
                                <td width="115" valign="top"><div class="dropbox_OTC" style="width:85px;">
                                        <select name="relationCd[]" id="relationCd-<?php echo $i; ?>" class="styled" onChange="changeTitleCd(this,<?php echo $i; ?>);" style="width:80px; font-weight:normal;">                                           
                                            <option value="SELF" <?php if (@$jsonDependentDetail[$dep]->relationCd == 'SELF') { ?> selected="selected" <?php } ?>>Self</option>                                        </select>
                                    </div></td>
                                <td width="115" valign="top"><div class="dropbox_OTC" style="width:85px;">
                            ...
                            <div class="feveo_otc_left">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="borderno">
                                    ...
                                    <tr>
                                        ...
                                        <td height="0">:</td>
                                        <td height="0"><input name="policypage[amount]" type="text" value="<?php echo $resultAllData[0]['PREMIUM_AMOUNT']; ?>" readonly class="medium_inputHealth mob_inputHealth gapB" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td height="0">
                                            <div style="width:85px;" class="drop_Health gapBl" id="ValidTitleAddClass">
                                                <select name="policypage[paymenttype]" id="paymentType">
                                    ...
                                    <tr>
                                        ...
                                        <td height="0">:</td>
                                        <td height="0"><input name="policypage[transactiondate]" type="text" class="medium_inputHealth mob_inputHealth gapB" /></td>
                                    </tr>
                                </table>
