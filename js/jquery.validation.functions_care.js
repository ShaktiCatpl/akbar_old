...
jQuery(function() {
    ...
    for (k = 1; k <= t; k++) {
        jQuery("#relationCd-" + k).validate({
            expression: "if (VAL != '0'){  $('#ValidRelationAddClass-" + k + "').removeClass();$('#ValidRelationAddClass-" + k + "').addClass('drop_Health1'); return true; }else{ $('#ValidRelationAddClass-" + k + "').addClass('ErrorField'); return false;}"
        });
