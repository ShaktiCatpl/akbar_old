...
//******************************************************************************
    ...
    var scwTodayCellBorderColour = '#1F713F';
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            'td.scwInputDate            {background-color:  #1F713F;'   +
										'font-weight:        bold;'    +
                                        'color:             #ffffff;}'  +
            '/* Weekend Day */'                                         +
            ...
            '/* Active cells */'                                        +
            'td.scwCells:hover,'                                        +
            'td.scwCellsHover           {background-color:  #1F713F;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #ffffff;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate:hover,'                                    +
            'td.scwInputDateHover       {background-color:  #1F713F;'   +
                                        'cursor:            pointer;'   +
										'font-weight:        bold;'    +
                                        'color:             #ffffff;}'  +
            '/* Weekend cells */'                                       +
            'td.scwCellsWeekend:hover,'                                 +
            'td.scwCellsWeekendHover    {background-color:  #1F713F;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #ffffff;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth:hover,'                                 +
            'td.scwCellsExMonthHover    {background-color:  #1F713F;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #ffffff;}'  +
            '/* Today selector */'                                      +
            'td.scwNow:hover,'                                          +
...
// ****************************************************************************
    ...
    function scwShow(scwEle,scwSource,defaultDate)
