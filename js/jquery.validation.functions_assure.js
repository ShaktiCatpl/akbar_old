...
jQuery(function() {
    ...
    jQuery("#ValidPinCode").validate({
     ...
     jQuery("#NomineeName").validate({
        expression: "if(VAL.match(/^[a-zA-Z \(\)]+$/) && myTrim(VAL).length>=2 ) {  return true; } else { jQuery('#errordisplayPrashant').show(); return false; } ",
    ...
    jQuery('.AdvancedForm').validated(function() {
        ...
        document.savePageassureForm.submit();
