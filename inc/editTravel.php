...
<script type="text/javascript">
    ...
    $(document).ready(function () {
            ...
            <?php 
                ...
                {
                    $ageBandArray = json_encode($_POST['eachmember']); 
                }
                else if($noofbands[0])
                {                
                    $ageBandArray = json_encode($noofbands);
                }
                else
                {
                    $ageBandArray = json_encode(array('0-40', '0-40', '0-40', '0-40', '0-40', '0-40'));
                }
                echo $ageBandArray;
            ?>;
            $("#selectedtravellers").val(agedata);
        //removeAgeBand();
...
<div class="mid_inner_container_otc" id="getSearch" style="display:<?php echo $traveldisplay; ?>;">
                ...
                <tr>
                    <td>
                        <table width="959" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td height="40" align="left" valign="middle"><strong>Edit Travelling To: <img onmouseover="Tip('Please select the Region of your destination you wish to buy Travel Insurance for. The highlights of the same plan will be shown on the side of page.');" 
                                                     onmouseout="UnTip();" src="<?php echo $sitepathTravel; ?>images/questionsmark.jpg"></strong></td>
                                                    ...
                                                    <tr>
                                                        <td width="100" height="39">
                                                            <div class="dropboxdate">
                                                                <input name="startDate" type="text" id="from" placeholder="Start Date"  value="<?php echo @$_POST['startDate']? $_POST['startDate']: $UTM_SOURCE['tripStartDate']; ?>" class="medium_inputdate"  readonly="yes" style="cursor:pointer;" />
                                                            </div>
                                                        </td>
                                                        <td width="100">
                                                            <div class="dropboxdate">
                                                                <input name="endDate" type="text" id="to" placeholder="End Date" value="<?php echo @$_POST['endDate']? $_POST['endDate']: $UTM_SOURCE['tripEndDate']; ?>" class="medium_inputdate" readonly="yes" style="cursor:pointer;"/>
                                                            </div>
                                                        </td>
  ...
  <select name="noOfTravellers" id="noOfTravellers" onchange="removeAgeBand();" style="width:73px; margin-left:3px;">
     <!--<select name="noOfTravellers" id="noOfTravellers" style="width:73px; margin-left:3px;">-->
       ...
       <option value="6" <?php if (@$resultData['MEMBER_COUNT'] == 6 or $_POST['noOfTravellers'] == 6) { echo "selected"; }  ?>>06</option>
                                    ...
                                    <input type="hidden" id="selectedtravellers">
                                </td>
                            </tr>
                                    ...
                                    <table width="93" border="0" cellspacing="0" cellpadding="0" class="date1 fl memberlist"  id="aged_1">
                                        ...
                                        <tr>
                                            ...
                                            <select id="age1" name="eachmember[]" style="width:70px;" class="age" >
                                                <option value="0-40" <?php if($noofbands[0] == "0-40"  || $postNoBands[0] == "0-40"){ echo "selected"; } ?>>upto 40</option>
                                                <option value="41-60"<?php if($noofbands[0] == "41-60" || $postNoBands[0] == "41-60"){ echo "selected"; } ?>>41 - 60</option>
                                                <option value="61-70"<?php if($noofbands[0] == "61-70" || $postNoBands[0] == "61-70"){ echo "selected"; } ?>>61 - 70</option>
                                                <option value="71-80"<?php if($noofbands[0] == "71-80" || $postNoBands[0] == "71-80"){ echo "selected"; } ?>>71 - 80</option>
                                                <option value="81-99"<?php if($noofbands[0] == "81-99" || $postNoBands[0] == "81-99"){ echo "selected"; } ?>>80 +</option>
                                            </select>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td height="28">
                                                <select id="age2" name="eachmember[]" style="width:70px;" class="age" >
                                                    <option value="0-40" <?php if($noofbands[1] == "0-40"  || $postNoBands[1] == "0-40"){ echo "selected"; } ?>>upto 40</option>
                                                    <option value="41-60"<?php if($noofbands[1] == "41-60" || $postNoBands[1] == "41-60"){ echo "selected"; } ?>>41 - 60</option>
                                                    <option value="61-70"<?php if($noofbands[1] == "61-70" || $postNoBands[1] == "61-70"){ echo "selected"; } ?>>61 - 70</option>
                                                    <option value="71-80"<?php if($noofbands[1] == "71-80" || $postNoBands[1] == "71-80"){ echo "selected"; } ?>>71 - 80</option>
                                                    <option value="81-99"<?php if($noofbands[1] == "81-99" || $postNoBands[1] == "81-99"){ echo "selected"; } ?>>80 +</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td height="28">
                                                <select id="age3" name="eachmember[]" style="width:70px;" class="age" >
                                                    <option value="0-40" <?php if($noofbands[2] == "0-40"  || $postNoBands[2] == "0-40"){ echo "selected"; } ?>>upto 40</option>
                                                    <option value="41-60"<?php if($noofbands[2] == "41-60" || $postNoBands[2] == "41-60"){ echo "selected"; } ?>>41 - 60</option>
                                                    <option value="61-70"<?php if($noofbands[2] == "61-70" || $postNoBands[2] == "61-70"){ echo "selected"; } ?>>61 - 70</option>
                                                    <option value="71-80"<?php if($noofbands[2] == "71-80" || $postNoBands[2] == "71-80"){ echo "selected"; } ?>>71 - 80</option>
                                                    <option value="81-99"<?php if($noofbands[2] == "81-99" || $postNoBands[2] == "81-99"){ echo "selected"; } ?>>80 +</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td height="28">
                                                <select id="age4" name="eachmember[]" style="width:70px;" class="age" >
                                                    <option value="0-40" <?php if($noofbands[3] == "0-40"  || $postNoBands[3] == "0-40"){ echo "selected"; } ?>>upto 40</option>
                                                    <option value="41-60"<?php if($noofbands[3] == "41-60" || $postNoBands[3] == "41-60"){ echo "selected"; } ?>>41 - 60</option>
                                                    <option value="61-70"<?php if($noofbands[3] == "61-70" || $postNoBands[3] == "61-70"){ echo "selected"; } ?>>61 - 70</option>
                                                    <option value="71-80"<?php if($noofbands[3] == "71-80" || $postNoBands[3] == "71-80"){ echo "selected"; } ?>>71 - 80</option>
                                                    <option value="81-99"<?php if($noofbands[3] == "81-99" || $postNoBands[3] == "81-99"){ echo "selected"; } ?>>80 +</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td height="28">
                                                <select id="age5" name="eachmember[]" style="width:70px;" class="age" >
                                                    <option value="0-40" <?php if($noofbands[4] == "0-40"  || $postNoBands[4] == "0-40"){ echo "selected"; } ?>>upto 40</option>
                                                    <option value="41-60"<?php if($noofbands[4] == "41-60" || $postNoBands[4] == "41-60"){ echo "selected"; } ?>>41 - 60</option>
                                                    <option value="61-70"<?php if($noofbands[4] == "61-70" || $postNoBands[4] == "61-70"){ echo "selected"; } ?>>61 - 70</option>
                                                    <option value="71-80"<?php if($noofbands[4] == "71-80" || $postNoBands[4] == "71-80"){ echo "selected"; } ?>>71 - 80</option>
                                                    <option value="81-99"<?php if($noofbands[4] == "81-99" || $postNoBands[4] == "81-99"){ echo "selected"; } ?>>80 +</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td height="28"><div class="dropbox_long_travel">
                                                    <select id="age6" name="eachmember[]" style="width:70px;" class="age" >
                                                        <option value="0-40" <?php if($noofbands[5] == "0-40"  || $postNoBands[5] == "0-40"){ echo "selected"; } ?>>upto 40</option>
                                                        <option value="41-60"<?php if($noofbands[5] == "41-60" || $postNoBands[5] == "41-60"){ echo "selected"; } ?>>41 - 60</option>
                                                        <option value="61-70"<?php if($noofbands[5] == "61-70" || $postNoBands[5] == "61-70"){ echo "selected"; } ?>>61 - 70</option>
                                                        <option value="71-80"<?php if($noofbands[5] == "71-80" || $postNoBands[5] == "71-80"){ echo "selected"; } ?>>71 - 80</option>
                                                        <option value="81-99"<?php if($noofbands[5] == "81-99" || $postNoBands[5] == "81-99"){ echo "selected"; } ?>>80 +</option>
                                                    </select>
